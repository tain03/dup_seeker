...
![GitHub release (latest by date)](https://img.shields.io/badge/release-v2.4--Final-emerald.svg?style=flat-square)
...
*   **🛡️ One-Touch Formula Protection:** Secure all formulas instantly with a new **`🛡️ PROTECT FORMULAS`** sidebar button. It utilizes Excel's native `SpecialCells` to automatically lock all formula cells and protect worksheets with password `'1'`, while keeping raw input data and shape drawings fully editable.
...
1. Download and extract **`DUP-SEEKER_v2.4_Final.zip`**.
