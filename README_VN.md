...
*   **🛡️ Bảo vệ Công thức Một chạm**: Tính năng **`🛡️ PROTECT FORMULAS`** trên sidebar cho phép tự động quét toàn bộ trang tính, khóa cứng các ô chứa công thức bằng công nghệ `SpecialCells` siêu tốc và bảo vệ sheet bằng mật khẩu `'1'`, trong khi vẫn cho phép nhập liệu thô và chỉnh sửa hình vẽ/ảnh tự do.
...
1. Tải về và giải nén tệp tin **`DUP-SEEKER_v2.4_Final.zip`**.
